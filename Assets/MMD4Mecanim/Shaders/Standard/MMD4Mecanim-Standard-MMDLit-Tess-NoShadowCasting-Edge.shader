Shader "MMD4Mecanim/Standard/MMDLit-Tess-NoShadowCasting-Edge"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "Queue" = "Geometry+1" "RenderType"="Opaque" "PerformanceChecks"="False" "ForceNoShadowCasting" = "True" }
		LOD 300
	...
	FallBack "MMD4Mecanim/Standard/MMDLit-NoShadowCasting-Edge"
