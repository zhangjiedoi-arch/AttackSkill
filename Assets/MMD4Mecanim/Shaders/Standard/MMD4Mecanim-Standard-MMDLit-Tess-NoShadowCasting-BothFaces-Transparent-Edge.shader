Shader "MMD4Mecanim/Standard/MMDLit-Tess-NoShadowCasting-BothFaces-Transparent-Edge"
{
	Properties
	{
	...
	FallBack "MMD4Mecanim/Standard/MMDLit-NoShadowCasting-BothFaces-Transparent-Edge"
